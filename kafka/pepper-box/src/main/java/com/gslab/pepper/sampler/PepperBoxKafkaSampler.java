...
public class PepperBoxKafkaSampler extends AbstractJavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, "SASL_PLAINTEXT");
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        try {
            if (key_message_flag) {
                ...
                producerRecord = new ProducerRecord<String, Object>(topic, message_val.toString());
            }
